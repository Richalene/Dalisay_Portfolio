...
import avatar from '../assets/transparentme.png';
...
const ProfileCardComponent = ({
  ...
  miniAvatarUrl,
  name = 'Mary Dalisay',
  title = 'Aspiring Linux System Administrator',
  handle = 'macentosh_os',
  status = 'Online',
  contactText = 'Contact',
  showUserInfo = false,
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(150, 100, 255, 0.55)',
      ...
      '--sunpillar-1': 'hsl(265, 70%, 60%)',
      '--sunpillar-2': 'hsl(280, 90%, 65%)',
      '--sunpillar-3': 'hsl(255, 90%, 65%)',
      '--sunpillar-4': 'hsl(290, 90%, 55%)',
      '--sunpillar-5': 'hsl(190, 90%, 65%)',
      '--sunpillar-6': 'hsl(270, 90%, 68%)',
              ...
              <div className="w-full absolute flex flex-col" style={{ top: '3em', display: 'flex', gridArea: 'auto' }}>
                <h3
                  ...
                  style={{
                    ...
                    backgroundImage: 'linear-gradient(to bottom, #fff, #aa39ad)',
                ...
                <p
                  ...
                  style={{
                    ...
                    fontSize: '16px',
                    margin: '0 auto',
                    backgroundImage: 'linear-gradient(to bottom, #fff, #ce6bc9)',
                    backgroundSize: '1em 1.5em',
                    WebkitTextFillColor: 'transparent',
                    backgroundClip: 'text',
                    WebkitBackgroundClip: 'text',
